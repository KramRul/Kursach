...
namespace Kursach
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            buttonStartRecording.Click += OnButtonStartRecordingClick;
            buttonStopRecording.Click += OnButtonStopRecordingClick;
        ...
        {
            //Double[] data = Class1.prepare(outputFolder, (string)listBoxRecordings.SelectedItem);
